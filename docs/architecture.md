...
- Local MLX-Gen supports `text_to_image` for curated q4/q8 FLUX.2, Qwen Image, Z-Image, and ERNIE Image Turbo presets, and supports `image_to_image` for FLUX.2 klein/base plus Qwen Image Edit (no masks yet).
